...
// Polyfill DOMMatrix, Path2D, and ImageData for Node.js serverless environment
...
if (typeof globalThis.Path2D === 'undefined') {
  class Path2D { constructor() {} addPath() {} closePath() {} moveTo() {} lineTo() {} bezierCurveTo() {} quadraticCurveTo() {} arc() {} arcTo() {} ellipse() {} rect() {} }
  globalThis.Path2D = Path2D;
  if (typeof global !== 'undefined') global.Path2D = Path2D;
}
if (typeof globalThis.ImageData === 'undefined') {
  class ImageData { constructor(w, h) { this.width = w || 1; this.height = h || 1; this.data = new Uint8ClampedArray((this.width * this.height) * 4); } }
